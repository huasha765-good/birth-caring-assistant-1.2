      ...
      <div className="p-4 pt-0">
          ...
          <li key={index} className="border-b border-gray-100 pb-3 last:border-0">
                <div className="text-gray-800 flex">
                  <span className="text-body-md break-words text-left block w-full pl-0">{item.text}</span>
                </div>
                {item.subItems &&
              <ul className="mt-2 ml-0 space-y-1">
                ...
                <li key={subIndex} className="text-gray-600 flex">
                      ...
                      <span className="break-words my-[5px] text-[14px] text-left pl-0">{subItem}</span>
                    </li>
                )}
                  </ul>
              }
