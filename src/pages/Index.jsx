...
const Index = () => {
  ...
  const careGuideData = [
    ...
    },
    {
      ...
      items: [
        { text: '手术后跑去吃饭，不在门口等老婆', completed: false },
        { text: '让一堆亲戚围观老婆喂奶或问"有没有奶"', completed: false },
        { text: '婆媳有矛盾时不站老婆', completed: false },
        { text: '觉得老婆"矫情"、"大惊小怪"', completed: false },
        { text: '月子里甩手不管，让老婆一个人带娃', completed: false },
        { text: '不控制探视，让老婆精疲力竭应付亲戚', completed: false }
      ]
    }
  ];
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white pb-20">
      <header className="bg-white shadow-sm sticky top-0 z-10">
        <div className="container mx-auto px-4 py-4">
          <h1 className="text-2xl font-bold text-center text-blue-800">准爸爸剖腹产护理助手</h1>
          <p className="text-center text-gray-600 mt-1">陪伴是最好的照顾</p>
        </div>
      </header>
      ...
      <main className="container mx-auto px-4 py-6">
        <div className="mb-8 text-center">
          <img 
            ...
            alt="准爸爸照顾新生儿" 
            className="mx-auto object-cover rounded-lg shadow-md h-48 w-full max-w-md"
          />
