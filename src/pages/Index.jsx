...
import { Heart, User, Shield, Star, Calendar, Baby, CheckCircle, Activity, Users, Clock, AlertTriangle, Home } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#e0f7fa]/60 to-[#bbdefb]/60 pb-20">
      ...
      <main className="container mx-auto px-4 py-4">
        <div className="mb-3 text-center">
          <img 
            src="https://s3plus.meituan.net/mcopilot-pub/nocode_image/default/jimeng-2026-03-13-3649-极简卡通风格，一家三口正视图头像，戴眼镜的长发妈妈，戴眼镜的爸爸，脸型更圆润的爸...-sejo4574hn6vam3af28l7rwe94rcy2.png"
            alt="准爸爸照顾新生儿" 
            className="mx-auto object-cover rounded-lg shadow-sm h-48 w-full max-w-md"
          />
          <p className="mt-3 text-gray-600 max-w-2xl mx-auto text-left text-[13px]">
            你现在的每一点照顾，都是给感情存钱。加油，准爸爸！ 💪
          </p>
        </div>
